        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="text-center">
                    <img src="{{ $student->profile_picture }}" class="avatar rounded-circle" alt="avatar" id="avatar" name="avatar" width="150" height="150">
                </div>
            </div>
            <!-- edit form column -->
            <div class="col-md-8 personal-info">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" type="text" value="{{ $student->firstName }}" name="firstName" id="firstName">
                    </div>
                </div>
                <div class="form-group">
